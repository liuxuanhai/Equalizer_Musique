...
public abstract class StreamChunk extends Chunk {
    ...
    public String prettyPrint(final String prefix) {
        return super.prettyPrint(prefix) + prefix + "  |-> Stream number: " +
                getStreamNumber() + Utils.LINE_SEPARATOR +
                prefix + "  |-> Type specific data size  : " +
                getTypeSpecificDataSize() + Utils.LINE_SEPARATOR +
                prefix + "  |-> Stream specific data size: " +
                getStreamSpecificDataSize() +
                Utils.LINE_SEPARATOR +
                prefix + "  |-> Time Offset              : " +
                getTimeOffset() + Utils.LINE_SEPARATOR +
                prefix + "  |-> Content Encryption       : " +
                isContentEncrypted() + Utils.LINE_SEPARATOR;
    }
