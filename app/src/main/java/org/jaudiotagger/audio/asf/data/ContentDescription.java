...
public final class ContentDescription extends MetadataContainer {
    ...
    static {
        ALLOWED = new HashSet<>(Arrays.asList(KEY_AUTHOR,
    ...
    public String prettyPrint(final String prefix) {
        return super.prettyPrint(prefix) + prefix + "  |->Title      : " + getTitle() +
                Utils.LINE_SEPARATOR +
                prefix + "  |->Author     : " + getAuthor() +
                Utils.LINE_SEPARATOR +
                prefix + "  |->Copyright  : " +
                getCopyRight() + Utils.LINE_SEPARATOR +
                prefix + "  |->Description: " + getComment() +
                Utils.LINE_SEPARATOR +
                prefix + "  |->Rating     :" + getRating() +
                Utils.LINE_SEPARATOR;
    }
